...
def build_parser(handlers: argparse.Namespace) -> argparse.ArgumentParser:
    ...
    sb.add_argument("--target", required=True, choices=["atom-echo", "atom-echos3r"], help="Target device family for OTA compatibility checks")
    ...
    smdns.add_argument("--host", required=True, help="Device host/IP")
    ...
    sstate.add_argument("--host", required=True, help="Device host/IP")
    ...
    satt.add_argument("--host", required=True, help="Device host/IP")
    ...
    scertg.add_argument("--host", required=True, help="Device host/IP")
    ...
    scerti.add_argument("--host", required=True, help="Device host/IP")
    scerti.add_argument("--key", dest="key_path", required=True, help="Admin signer private key PEM")
    ...
    scertp.add_argument("--host", required=True, help="Device host/IP")
    ...
    skeym.add_argument("--host", required=True, help="Device host/IP")
    skeym.add_argument("--key", dest="key_path", required=True, help="Admin private key PEM")
    ...
    ssign.add_argument("--host", required=True, help="Device host/IP")
    ...
    sattv.add_argument("--host", required=True, help="Device host/IP")
    ...
    sredir.add_argument("--host", required=True, help="Device host/IP")
