...
def build_parser(handlers: argparse.Namespace) -> argparse.ArgumentParser:
    ...
    sb.add_argument("--target", default="", choices=["atom-echo", "atom-echos3r"], help="Target device family for OTA compatibility checks (recommended; defaults inferred from --env)")
    sb.add_argument("--env", default="atom-echo", help="PlatformIO env for build fallback")
