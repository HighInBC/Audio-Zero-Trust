...
def build_handler_namespace(
    *,
    ...
    return argparse.Namespace(
        ...
        cmd_stream_listen=cmd_stream_listen.run,
        cmd_stream_terminate=cmd_stream_terminate.run,
        ...
        cmd_tls_bootstrap=cmd_tls_bootstrap.run,
