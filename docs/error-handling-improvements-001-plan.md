...
- [~] Phase 5: Service-layer network calls (`operations_service`, `device_service`, `tls_service`) include attempted URL/endpoint on failures (in progress: core request paths updated + apply/config-patch covered)
