...
- [~] Phase 6: Replace ambiguous combined validation failures with one-code-per-condition in remaining high-traffic paths (in progress: configure-device and provisioning serial-gate split)
